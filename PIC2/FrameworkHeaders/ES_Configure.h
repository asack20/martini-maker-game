...
#define SERV_0_HEADER "LED_single_FSM.h"
// the name of the Init function
#define SERV_0_INIT InitLED_single_FSM
// the name of the run function
#define SERV_0_RUN RunLED_single_FSM
// How big should this services Queue be?
#define SERV_0_QUEUE_SIZE 30
...
#if NUM_SERVICES > 1
// the header file with the public function prototypes
#define SERV_1_HEADER "PIC2ButtonFSM.h"
// the name of the Init function
#define SERV_1_INIT InitPIC2ButtonFSM
// the name of the run function
#define SERV_1_RUN RunPIC2ButtonFSM
// How big should this services Queue be?
...
#if NUM_SERVICES > 2
// the header file with the public function prototypes
#define SERV_2_HEADER "P2PComm.h"
// the name of the Init function
#define SERV_2_INIT InitP2PComm
// the name of the run function
#define SERV_2_RUN RunP2PTransmit
// How big should this services Queue be?
...
#define EVENT_CHECK_LIST Check4Btns, CheckP2PReceiveEvents
...
//#define TIMER0_RESP_FUNC BTN_TIMER
#define TIMER1_RESP_FUNC TIMER_UNUSED
//#define TIMER1_RESP_FUNC PostTestP2PService
#define TIMER2_RESP_FUNC PostPIC2ButtonFSM
